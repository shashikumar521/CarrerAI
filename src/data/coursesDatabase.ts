...
export const REAL_WORLD_COURSES: CourseRecommendation[] = [
  ...
  },
  {
    ...
    officialUrl: 'https://explore.skillbuilder.aws/learn/course/external/view/elearning/14468/exam-prep-aws-certified-devops-engineer-professional',
    handsOn: true,
    targetRoles: ['Cloud & DevOps Engineer', 'Software Development Engineer (SDE)'],
    levelOrder: 'ADVANCED',
    marketDemand: 'Very High',
  ...
  },
  {
    ...
    officialUrl: 'https://explore.skillbuilder.aws/learn/public/learning_plan/view/82/solutions-architect-learning-plan',
    handsOn: true,
  ...
  },
  {
    ...
    officialUrl: 'https://www.nvidia.com/en-us/training/instructor-led-workshops/building-rag-agents-with-llms/',
    handsOn: true,
    targetRoles: ['AI / Machine Learning Engineer', 'Software Development Engineer (SDE)'],
    levelOrder: 'ADVANCED',
    marketDemand: 'Extremely High',
  ...
  },
  {
    ...
    officialUrl: 'https://www.nvidia.com/en-us/training/instructor-led-workshops/fundamentals-of-accelerated-computing-with-cuda-c/',
    handsOn: true,
