          ...
          {navItems.map((item) => {
            ...
            return (
              <button
                ...
                className={`w-full flex items-center justify-between text-left px-3 py-2.5 rounded-xl text-sm sm:text-[15px] font-medium tracking-normal leading-snug transition-all duration-200 cursor-pointer group ${
                  isActive
              ...
              >
                <div className="flex items-center gap-2.5 min-w-0 text-left">
                  ...
                  />
                  <span className="text-left whitespace-normal lg:whitespace-nowrap">
                    {item.label}
                  </span>
                </div>
                {item.badge && (
                  <span className="px-2 py-0.5 rounded-full text-[10px] font-bold bg-emerald-50 text-emerald-700 border border-emerald-200 shrink-0 ml-2">
                    {item.badge}
                  </span>
                )}
              </button>
