        ...
        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4 border-b border-slate-100 pb-6">
          <div className="space-y-1">
            ...
            <p className="text-sm text-slate-600 max-w-3xl leading-relaxed">
              Explore verified tech and engineering openings retrieved from established jobs APIs. Every listing features official application URLs and transparent profile matching.
            </p>
          </div>
        ...
        >
          ...
          <div className="flex flex-wrap items-center justify-center gap-3 pt-2">
            <button
              id="retry-jobs-btn"
              onClick={() => loadJobs(true)}
              className="px-5 py-2.5 bg-rose-600 hover:bg-rose-700 text-white rounded-xl text-xs font-extrabold transition-colors cursor-pointer shadow-xs"
            >
              Retry Live Jobs
            </button>
            <button
                  ...
                  <div className="lg:w-72 shrink-0 bg-slate-50/80 border border-slate-200 rounded-xl p-4 space-y-3.5 flex flex-col justify-between">
                    ...
                    <div className="space-y-2">
                      <div className="flex items-center justify-between">
                        ...
                        <span
                          className={`text-sm font-black px-2.5 py-0.5 rounded-full border ${
                    ...
                    <div className="space-y-2 pt-2 border-t border-slate-200">
                      ...
                      <a
                        ...
                        className="w-full inline-flex items-center justify-center gap-2 px-4 py-2.5 bg-indigo-600 hover:bg-indigo-700 active:bg-indigo-800 text-white rounded-xl text-xs font-extrabold shadow-xs transition-colors cursor-pointer"
                      >
